...
import static com.example.myapplication.MainActivity.doGet;
...
public class ColorRound extends View implements View.OnTouchListener {
    ...
    com.example.myapplication.Color[] color;
    double ug = 0;
    int event = -1;
    Context context;
    int width;
    ...
    public ColorRound(Context context, int length, com.example.myapplication.Color[] color, int width,
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        int back_color = Color.argb(255, 62, 62, 62);
    ...
    class ResThread implements Runnable {
        String url = context.getResources().getString(R.string.address);
